...
We will deploy three tasks designed to elicit either mainly _response speed_ or _evidence quality_ errors or both. A modified Flanker task will be used to elicit both error types. A modified version of the _Behavioral Adaptation Task_ [@hester2007post] will be used to elicit mainly _response speed_ errors and a difficult color discrimination task [@buzzell2017error] will be used to elicit mainly _evidence quality_ errors.
